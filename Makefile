...
READ_DIR_OBJ = cut_file_path_from_files_or_dirs.o read_with_hidden_files.o read_dir_standard.o
INIT_ARGS_OBJ = initialize_arguments.o run_with_no_files_or_repos_passed.o
