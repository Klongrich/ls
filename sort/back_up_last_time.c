...
void merge_last_time_accessed_sort2(char* arr[], int l, int r, int r_flag) {
    if (l < r) {
        int m = l + (r - l) / 2;
        merge_last_time_accessed_sort2(arr, l, m, r_flag);
        merge_last_time_accessed_sort2(arr, m + 1, r, r_flag);
